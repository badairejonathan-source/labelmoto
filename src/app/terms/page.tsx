      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6 text-foreground/90 leading-relaxed">
            ...
            <p>Les sources des informations diffusées sur le site Label Moto sont réputées fiables mais le site ne garantit pas qu’il soit exempt de défauts, d’errors ou d’omissions. L'Utilisateur s'assure de garder son mot de passe secret. Toute divulgation du mot de passe, quelle que soit sa forme, est interdite.</p>
          </div>
        </div>
      </main>
    </div>
