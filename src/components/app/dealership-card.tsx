  ...
  return (
    <>
      ...
      <Card
        onClick={onClick}
        className={cn(
          "w-full overflow-hidden transition-shadow duration-300 ease-in-out cursor-pointer hover:shadow-md border-border/50 shadow-sm bg-card md:min-h-[180px]",
          className
        )}
      >
        {/* Horizontal Scroll for Swipe on Mobile, Static Row on Desktop */}
        <div className="flex overflow-x-auto snap-x snap-mandatory no-scrollbar md:overflow-visible md:snap-none md:flex-row h-40 md:h-auto md:min-h-[180px]">
          
          {/* Main Content Area */}
          <div className="flex-none w-full min-w-full snap-start md:min-w-0 md:flex md:w-auto md:flex-1 h-full flex bg-card">
            {/* Image section: Full height and wider */}
            <div
              onClick={handleImageClick}
              className={cn(
                "relative w-40 md:w-64 flex-shrink-0 md:rounded-l-lg md:rounded-r-none overflow-hidden md:border-r bg-muted/30 h-full min-h-[160px] md:min-h-[180px]",
            ...
            <div className="flex flex-col justify-center flex-1 p-4 md:p-6 min-w-0 h-full">
          ...
          {/* Hours Section: Revealed via swipe left on mobile */}
          <div className="flex-none w-[220px] snap-end p-4 bg-muted/30 flex flex-col justify-center md:snap-none md:w-64 md:bg-transparent md:p-6 h-full border-l-2 border-brand/20 md:border-l md:border-border/70">
