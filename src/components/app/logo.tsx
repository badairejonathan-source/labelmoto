...
const LabelMotoLogo = ({ className, imageClassName }: { className?: string; imageClassName?: string }) => {
  return (
    <Link 
      href="/" 
      className={cn(
        'relative block z-[100] group bg-white/95 backdrop-blur-md rounded-full shadow-[0_15px_40px_rgba(0,0,0,0.15)] border border-white/40 px-6 py-2.5 transition-all hover:scale-[1.03] active:scale-95', 
        className
      )}
    >
      <Image 
