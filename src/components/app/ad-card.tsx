  ...
  return (
    <Link href={href} className="group block w-full">
      <Card className={cn(
        ...
        <div className="relative w-28 sm:w-56 md:w-72 flex-shrink-0 overflow-hidden bg-muted">
          <Image src={imageUrl} alt={article.title} fill className="object-cover transition-transform duration-1000 group-hover:scale-110" data-ai-hint={article.imageHint || "motorcycle"} sizes="(max-width: 768px) 112px, 300px" />
