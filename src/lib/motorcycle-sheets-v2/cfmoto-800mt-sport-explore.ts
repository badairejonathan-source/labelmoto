...
export const cfmoto800mtSportExploreVariants = [
  ...
  {
    "label": "800MT Touring (2025+)",
    "license_bridging": "A2 35 kW / A 67 kW selon homologation",
    "engine_type": "Bicylindre en ligne 4T, liquide, DOHC",
    "displacement_cc": 799,
    ...
    "tank_l": 19,
    "cycle_parts": {
      "front_brake": "Double disque J.Juan Ø320 mm",
      "rear_brake": "Simple disque J.Juan Ø260 mm",
      "front_tire": "110/80 R19",
      "rear_tire": "150/70 R17"
    },
    "equipment_note": "Selle standard 825 mm · selle haute 855 mm en option."
  }
];
...
export const cfmoto800mtSportExploreV2: MotorcycleSheetV2 = {
  ...
  "quick_maintenance": [
    ...
    },
    {
      ...
      "value": "Tous les 15 000 km / 1 an",
      "confidence": "official_fr"
    },
    {
      "label": "Huile",
      "value": "SAE 10W-50 · API SJ+ · JASO MA2",
  ...
  "service_schedule_v2": [
    {
      ...
      "operations": [
        ...
        {
          "label": "Contrôles généraux, freinage, pneus, transmission et serrages",
          "source_type": "official_eu"
        }
      ],
    ...
    },
    {
      ...
      "operations": [
        {
          "label": "Échéance France 15 000 km ou annuelle",
          "source_type": "official_fr"
        },
        {
          "label": "Remplacement huile moteur et filtre",
        ...
        {
          "label": "Contrôle freinage, pneus, transmission et partie-cycle",
          "source_type": "official_eu"
        }
      ],
    ...
    },
    {
      ...
      "operations": [
        {
          "label": "Entretien périodique 15 000 km",
          "source_type": "official_fr"
        },
        {
        ...
        {
          "label": "Remplacement des bougies",
          "source_type": "official_eu"
        },
        {
    ...
    },
    {
      ...
      "operations": [
        {
          "label": "Échéance France 45 000 km ou annuelle",
          "source_type": "official_fr"
        },
        {
          "label": "Huile moteur, filtre et contrôles généraux",
          "source_type": "official_eu"
        }
      ],
      "price_estimate": "≈220–340 €",
    ...
    },
    {
      ...
      "operations": [
        ...
        {
          "label": "Opérations périodiques de 30 000 km à répéter selon tableau applicable",
          "source_type": "official_eu"
        }
      ],
    ...
    },
    {
      ...
      "operations": [
        {
          "label": "Échéance périodique 15 000 km",
          "source_type": "official_fr"
        }
      ],
      "price_estimate": "≈220–340 €",
    ...
    "cards": [
      {
        ...
        "value": "≈12,90 €",
        "note": "Prix observé ; vérifier référence au VIN."
      },
      {
        "label": "Filtre à air Sport / Explore",
        "value": "≈21,95 €",
        "note": "Prix observé ; compatibilité à vérifier selon millésime."
      },
      {
        "label": "Huile 10W-50",
        "value": "≈25 €/L",
        "note": "Repère observé ; 2,8 L documentés avec filtre."
      }
    ],
  ...
  "maintenance_details": [
    {
      ...
      "rows": [
        {
          "label": "Viscosité",
          "value": "SAE 10W-50 recommandé",
          "confidence": "official_other_market"
        },
        {
          "label": "Norme",
          "value": "API SJ ou supérieur · JASO T903 MA2 privilégié",
          "confidence": "official_other_market"
        },
        {
          "label": "Quantité avec filtre",
        ...
        {
          "label": "Remplacement",
          "value": "1 000 km puis tous les 15 000 km / 1 an",
          "confidence": "official_eu"
        },
        {
          "label": "Filtre à huile",
          "value": "Remplacement avec l’huile selon le tableau 800MT",
          "confidence": "official_eu"
        }
      ],
    ...
    },
    {
      ...
      "rows": [
        {
          "label": "Remplacement",
          "value": "Tous les 30 000 km",
          "confidence": "official_eu"
        },
        {
          "label": "Usage poussiéreux",
          "value": "Remplacement plus fréquent",
          "confidence": "official_eu"
        }
      ],
    ...
    },
    {
      ...
      "rows": [
        {
          "label": "Technologie",
          "value": "Liquide organique",
          "confidence": "official_eu"
        },
        {
          "label": "Capacité documentée",
          "value": "1,3 L + 180 mL (≈ 1,48 L)",
          "confidence": "official_other_market"
        }
      ],
    ...
    },
    {
      ...
      "rows": [
        {
          "label": "Liquide",
          "value": "DOT 4 ou DOT 5.1",
          "confidence": "official_eu"
        },
        {
          "label": "Avant",
          "value": "Double disque Ø320 mm · J.Juan",
          "confidence": "official_fr"
        },
        {
          "label": "Arrière",
          "value": "Simple disque Ø260 mm · J.Juan",
          "confidence": "official_fr"
        },
        {
          "label": "Contrôle",
          "value": "À chaque entretien et lors des vérifications de sécurité",
          "confidence": "official_eu"
        }
      ]
    },
    {
      ...
      "rows": [
        ...
        {
          "label": "Explore France actuelle",
          "value": "Jantes à rayons · Michelin Anakee Adventure",
          "confidence": "official_fr"
        }
      ]
    },
    {
      ...
      "rows": [
        ...
        {
          "label": "Limite d’allongement historique",
          "value": "320,7 mm maximum sur 20 maillons sous charge de 10 kg",
          "confidence": "official_other_market"
        },
        {
          "label": "Écrou axe arrière",
          "value": "90 Nm sur manuel constructeur 800MT historique",
          "confidence": "official_other_market"
        },
        {
          "label": "Conditions sévères",
          "value": "Contrôler et lubrifier plus fréquemment après pluie, lavage ou usage off-road",
          "confidence": "official_eu"
        }
      ]
    }
  ...
  "consumables_v2": [
    {
      ...
      "replacement_interval": "15 000 km / 1 an · 2,8 L avec filtre",
      "observed_price": "≈25 €/L",
      "source_type": "observed"
    },
    {
      "part": "Filtre à huile",
      "specification": "OEM famille 800 · 61338015200",
    ...
    {
      "part": "Filtre à air",
      "specification": "CFMOTO 800MT Sport / Explore",
      "replacement_interval": "Selon table du millésime",
      "observed_price": "≈21,95 €",
      "source_type": "observed",
      "note": "Vérifier VIN / millésime avant commande."
    }
  ],
  "known_issues_v2": [
    {
  ...
  "warranty": {
    "duration": "5 ans pour les Sport+ / Explore éligibles immatriculées en 2026",
    "coverage": "Années 1–2 : pièces et main-d’œuvre ; années 3–5 : pièces moteur / boîte / cadre",
    "market": "France",
    "maintenance_requirement": "Entretien obligatoire dans le réseau CFMOTO France pour l’extension concernée, carnet renseigné.",
    "claim_requirement": "Plafond 60 000 km sur 5 ans pour l’offre 2026 ; le contrat correspondant à la date d’immatriculation prévaut.",
    "source_label": "CFMOTO France · garantie 2026"
  },
  "equivalents_v2": [
    {
      "name": "Honda XL750 Transalp",
      "reason": "Trail routier polyvalent · plus léger · réseau très dense"
    },
    {
      "name": "Yamaha Ténéré 700",
      "reason": "Trail plus simple et plus orienté piste · référence du segment"
    },
    {
      "name": "Suzuki V-Strom 800DE",
      "reason": "Bicylindre de cylindrée proche · voyage et chemins"
    },
    {
      "name": "KTM 790 Adventure",
      "reason": "Architecture moteur proche · orientation trail plus marquée"
    }
  ],
  "verdict": {
    "score": 8.6,
